    ...
    >
      ...
      <div className="about-main">
        <div className="about-main__details">
          <p> A curiosity-driven Front-End Developer.</p>
          <p>
            I am a <span>Front-End Developer </span>
            career pivoting from the travel and education industry, with
            experience working with<span> React and Javascript. </span>I enjoy
            turning complex problems into simple, beautiful and intuitive apps
          ...
          <p>
            ...
            an active listener; traits that allow me to create great projects
          ...
          <p>
            ...
            in 2012, I swapped the keyboard for a camera (apron), and moved to
            Dubai then China where I spent time working in the travel and
            education industry. After I moved back to Europe, I came back to my
            original aspirations and worked my way up to
