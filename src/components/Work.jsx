    ...
    <section ref={ref} className="work-container">
      ...
      <div className="work-main">
        {projectList.map((project, index) => (
          <div
            className={`work-main__item ${index % 2 === 0 ? "" : "item-left"}`}
            key={index}
          >
            <a
            ...
            >
              <img src={project.image} alt="image_shopping_website" />
            </a>
            <div
              className={`work-main__item--details ${
                index % 2 === 0 ? "" : "detail-left"
              }`}
            >
              ...
              <div
                className={`item-tech ${index % 2 === 0 ? "" : "tech-left"}`}
              >
